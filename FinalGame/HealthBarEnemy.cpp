...
HealthBarEnemy::HealthBarEnemy(SDL_Renderer* renderer, Vector2 pos, int colWidth, int colHeight)
{
	m_position = pos;
	m_colWidth = colWidth;
...
void HealthBarEnemy::Draw(SDL_Renderer* renderer)
{
...
void HealthBarEnemy::Update(float deltaTime)
{
	m_collider->Update(m_position);
	m_animation->Update(deltaTime);
}

void HealthBarEnemy::HandleInput(float delatTime)
{

}

ColliderBox* HealthBarEnemy::GetCollider()
{
	return m_collider;
}
